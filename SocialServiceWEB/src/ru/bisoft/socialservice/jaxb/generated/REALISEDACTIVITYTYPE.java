...
public class REALISEDACTIVITYTYPE {
    ...
    @XmlElement(name = "PERFORMANCEDATE", required = true)
    ...
    @XmlElement(name = "PERIODLOW", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar periodlow;
    @XmlElement(name = "PERIODHIGH", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar periodhigh;
     ...
     *     
     */
    public XMLGregorianCalendar getPERIODLOW() {
        return periodlow;
    }
     ...
     *     
     */
    public void setPERIODLOW(XMLGregorianCalendar value) {
     ...
     *     
     */
    public XMLGregorianCalendar getPERIODHIGH() {
        return periodhigh;
    }
     ...
     *     
     */
    public void setPERIODHIGH(XMLGregorianCalendar value) {
