...
public class PHYSICALINABILITYTYPE {
    ...
    @XmlElement(name = "REEXAMINATIONTERM", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar reexaminationterm;
    @XmlElement(name = "REASON", required = true)
    protected String reason;
    @XmlElement(name = "BEGINNING", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar beginning;
     ...
     *     
     */
    public XMLGregorianCalendar getREEXAMINATIONTERM() {
     ...
     *     
     */
    public void setREEXAMINATIONTERM(XMLGregorianCalendar value) {
     ...
     *     
     */
    public XMLGregorianCalendar getBEGINNING() {
        return beginning;
    }
     ...
     *     
     */
    public void setBEGINNING(XMLGregorianCalendar value) {
